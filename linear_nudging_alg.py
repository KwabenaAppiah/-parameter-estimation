...
class LinearNudgingAlg:
    def __init__(self, *args):
        ...
        self._abs_graph_display = GraphicDisplay(args[0], "Absolute", self._ev_type, self._pp_type)
        self._rel_graph_display = GraphicDisplay(args[0], "Relative",  self._ev_type, self._pp_type)
