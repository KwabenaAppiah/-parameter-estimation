...
class LinearNudgingAlg:
    ...
    def result_output(self, update_times_mtrx, A, A_est, t, S, U, U_abs, U_rel, abs_param_err, rel_param_err, matrix_id_number ):
        ...
        rms_graph_color_abs = "purple"
        rms_graph_color_rel = "gray"

        # ABSOLUTE ERROR
        self._abs_graph_display.plot_2D_line_graph(t, U_list_abs, matrix_id_number, state_error_labels, "absolute_error", "Absolute State Error")
        self._abs_graph_display.plot_2D_line_graph(t, abs_param_err, matrix_id_number, self._param_list, "absolute_error", "Absolute Parameter Error")
        self._abs_graph_display.plot_2D_line_graph(t, [abs_state_err_rms], matrix_id_number,  ['Abs. State Err. (RMS)'], "absolute_error", "Absolute State Error RMS", rms_graph_color_abs)
        self._abs_graph_display.plot_2D_line_graph(t, [abs_param_err_rms], matrix_id_number, ['Abs. Param Err. (RMS)'], "absolute_error",  "Absolute Parameter Error RMS", rms_graph_color_abs)
        # self._abs_graph_display.plot_2D_line_graph(t, [abs_param_err_mean], matrix_id_number, ['Abs. Param Err. (MEAN)'], "absolute_error",  "Absolute Parameter Error MEAN", "purple")

        # RELATIVE ERROR
        self._rel_graph_display.plot_2D_line_graph(t, U_list_rel, matrix_id_number, state_error_labels, "relative_error",  "Relative State Error")
        self._rel_graph_display.plot_2D_line_graph(t, rel_param_err, matrix_id_number, self._param_list, "relative_error", "Relative Parameter Error")
        self._rel_graph_display.plot_2D_line_graph(t, [rel_state_err_rms], matrix_id_number, ['Rel. State Err. (RMS)'], "relative_error", "Relative State Error RMS", rms_graph_color_rel)
        self._rel_graph_display.plot_2D_line_graph(t, [rel_param_err_rms], matrix_id_number, ['Rel. Param Err. (RMS)'], "relative_error", "Relative Parameter Error RMS", rms_graph_color_rel)
